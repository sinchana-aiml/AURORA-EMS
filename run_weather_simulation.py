...
from weather_loader import load_weather_csv, validate_weather_records, make_sample_weather_csv
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("  run_weather_simulation.py  self-test")
    print("=" * 60)
